...
Outputs (written under --out-dir):
  - mgg_values.csv, mgg_hist.png
  - track_counts.csv, tracks_near_photons.png, tracks_near_jets.png
  - iso_values.csv, iso_photons.png, iso_jets.png
...
def main() -> None:
    ...
    out_dir = (
        ...
        if args.out_dir is not None
            ...
            "C:/Users/Tom Greenwood/Desktop/University/Year 4/SEM 2/SH Project/week6/analysis_v9_outputs"
        )
    )
    os.makedirs(out_dir, exist_ok=True)
    ...
    if n_trk_all_total > 0:
        ...
        ).to_csv(os.path.join(out_dir, "track_reduction.csv"), index=False)
    ...
    ).to_csv(os.path.join(out_dir, "track_ptmin_reduction.csv"), index=False)
    ...
    if len(fpr) > 0:
        ...
        cut99, tpr99, fpr99 = cut_at_fixed_tpr(ph_iso, jt_iso, 0.99)
